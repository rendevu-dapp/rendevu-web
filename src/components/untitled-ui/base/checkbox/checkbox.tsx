...
export const CheckboxBase = ({
  ...
  return (
    <div
      className={cx(
        "flex size-4 shrink-0 cursor-pointer appearance-none items-center justify-center rounded-md bg-white ring-1 ring-neutral-200 ring-inset",
        size === "md" && "size-5 rounded-lg",
        (isSelected || isIndeterminate) && "bg-secondary ring-secondary",

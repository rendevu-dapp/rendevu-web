...
import {
  Tooltip,
  TooltipTrigger,
} from "@/components/untitled-ui/base/tooltip/tooltip";
  ...
  return (
    <TableContext.Provider value={{ size }}>
      <div
        {...props}
        className={cx(
          "overflow-hidden rounded-xl bg-white shadow-xs ring-1 ring-default",
          className,
        )}
      >
        {children}
...
const TableCardHeader = ({
  ...
  return (
    <div
      className={cx(
        "relative flex flex-col items-start gap-4 border-b border-[#e9eaeb] bg-primary px-4 md:flex-row",
    ...
    <AriaTableHeader
      ...
      className={(state) =>
        cx(
          ...
          bordered &&
            "[&>tr>th]:after:pointer-events-none [&>tr>th]:after:absolute [&>tr>th]:after:inset-x-0 [&>tr>th]:after:bottom-0 [&>tr>th]:after:h-px [&>tr>th]:after:bg-[#e9eaeb] [&>tr>th]:focus-visible:after:bg-transparent",
      ...
      {(state) => (
        <AriaGroup className="flex items-center gap-1">
          <div className="flex items-center gap-1">
            {label && (
              <span className="text-xs font-semibold whitespace-nowrap text-[#717680]">
                {label}
              </span>
            )}
          ...
          {tooltip && (
            <Tooltip title={tooltip} placement="top">
              <TooltipTrigger className="cursor-pointer text-[#a4a7ae] transition duration-100 ease-linear hover:text-fg-quaternary_hover focus:text-fg-quaternary_hover">
...
const TableRow = <T extends object>({
  ...
  return (
    <AriaRow
      ...
      className={(state) =>
        cx(
          "relative outline-[#9e77ed] transition-colors after:pointer-events-none hover:bg-[#fafafa] focus-visible:outline-2 focus-visible:-outline-offset-2",
          size === "sm" ? "h-14" : "h-18",
          highlightSelectedRow && "selected:bg-[#fafafa]",
